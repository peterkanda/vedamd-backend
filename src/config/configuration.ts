...
export const configuration = (): AppConfig => ({
  ...
  models: {
    ...
    medgemmaVersion: process.env.MEDGEMMA_VERSION ?? 'medgemma-1.5-4b-it-q4_k_m',
    medgemmaQuantization: process.env.MEDGEMMA_QUANTIZATION ?? 'Q4_K_M',
    medgemmaModelFile: process.env.MEDGEMMA_MODEL_FILE ?? 'medgemma-1.5-4b-it-Q4_K_M.gguf',
    medgemmaModelSizeBytes: Number(process.env.MEDGEMMA_MODEL_SIZE_BYTES ?? 2_490_000_000),
    medgemmaModelSha256: process.env.MEDGEMMA_MODEL_SHA256 ?? '',
    medgemmaMmprojFile: process.env.MEDGEMMA_MMPROJ_FILE ?? 'medgemma-1.5-4b-it-mmproj-f16.gguf',
    medgemmaMmprojSizeBytes: Number(process.env.MEDGEMMA_MMPROJ_SIZE_BYTES ?? 851_000_000),
    ...
    medgemmaReleasedAt: process.env.MEDGEMMA_RELEASED_AT ?? '2026-01-13T00:00:00.000Z',
