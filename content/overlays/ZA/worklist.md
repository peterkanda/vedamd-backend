# South Africa (ZA) — content authoring worklist
...
- **South Africa Standard Treatment Guidelines + EML (EDL)** (South Africa National Department of Health) — `cite-only`, Government of South Africa copyright
...
## Sign-off checklist
- [ ] National overlay records authored & jurisdiction-tagged `ZA`
