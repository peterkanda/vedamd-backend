# Ghana (GH) — content authoring worklist
...
- **Ghana Standard Treatment Guidelines + EML** (Ghana Ministry of Health / GHS) — `cite-only`, Government of Ghana copyright
...
## Sign-off checklist
- [ ] National overlay records authored & jurisdiction-tagged `GH`
